...
**Tech:** Google Gemini Vision AI • Web Speech API • Real-time video processing  
...
Speech/Text Input → AI Processing → Sign Language Animation
```

**Real Example:** User signs "Hello, how are you?" → System speaks it aloud and displays text
...
**Deployment:** Google AI Studio • Local deployment ready  
